(function () {
    'use strict';
    function ProyectoCrearController($scope, $state,toaster,$uibModal,$log,ProyectoService) {
        $scope.materials = [
		                 {
		                     "tipoRecurso": "CIVIL",
    ...
    angular
	.module(app.name)
	.controller('ProyectoCrearController', ProyectoCrearController);

    ProyectoCrearController.$inject = ['$scope', '$state','toaster','$uibModal','$log','ProyectoService'];
