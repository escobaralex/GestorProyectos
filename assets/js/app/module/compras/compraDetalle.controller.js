(function () {
    'use strict';
    function ComprasDetalleController($scope, $state,toaster,$uibModal,$log,ComprasService) {
        $scope.materials = [
		                 {
		                     "tipoRecurso": "CIVIL",
    ...
    angular
	.module(app.name)
	.controller('ComprasDetalleController', ComprasDetalleController);

    ComprasDetalleController.$inject = ['$scope', '$state','toaster','$uibModal','$log','ComprasService'];
