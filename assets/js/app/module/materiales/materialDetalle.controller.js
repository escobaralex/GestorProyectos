(function () {
    'use strict';
    function MaterialDetalleController($scope, $state,toaster,$uibModal,$log,MaterialService) {
        $scope.materials = [
		                 {
		                     "tipoRecurso": "CIVIL",
    ...
    angular
	.module(app.name)
	.controller('MaterialDetalleController', MaterialDetalleController);

    MaterialDetalleController.$inject = ['$scope', '$state','toaster','$uibModal','$log','MaterialService'];
