(function () {
    'use strict';
    function ProyectoDetalleController($scope, $state,toaster,$log,ProyectoService) {
		$scope.tareas = [
			{
				 "numeroTarea":"1",
    ...
    angular
	.module(app.name)
	.controller('ProyectoDetalleController', ProyectoDetalleController);

    ProyectoDetalleController.$inject = ['$scope', '$state','toaster','$log','ProyectoService'];
